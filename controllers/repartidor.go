...
func listRepartidores(repartidores *[]models.Repartidor, gdb *gorm.DB) *gorm.DB {
	return gdb.Model(&models.Repartidor{}).Order("ID asc").Preload("Usuario").Find(&repartidores)
}
...
func getRepartidor(repartidor *models.Repartidor, id string, gdb *gorm.DB) *gorm.DB {
	return gdb.Model(&models.Repartidor{}).Order("ID asc").Preload("Usuario").Find(&repartidor, id)
}
